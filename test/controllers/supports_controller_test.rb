...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { message: @support.message, subject: @support.subject, user_id: @support.user_id } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { message: @support.message, subject: @support.subject, user_id: @support.user_id } }
